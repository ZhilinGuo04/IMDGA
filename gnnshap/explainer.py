...
class GNNShapExplainer:
    ...
    def explain(self, node_idx: int, nsamples: int,
                    batch_size: int = 512, graph = None, sampler_name: str = 'GNNShapSampler',
                    target_class: Union[int, None]=None, l1_reg: bool= False,neighbor = None,
                    solver_name: str = "WLSSolver", is_rgcn = False,**kwargs):
        ...
        #  sub_edge_mask) = pruned_comp_graph(int(node_idx), self.num_hops,
        #                                            self.data.edge_index,
        #                                            relabel_nodes=True,)
        
        (subset, sub_edge_index, sub_mapping,
         sub_edge_mask) = pruned_comp_graph_(int(node_idx), 
                                            self.num_hops,
                                            self.data.edge_index,
                                            neighbor,
                                            graph,
        ...
        self.sampler = get_sampler(
            ...
            target_node=sub_mapping.item(), **kwargs)
        ...
        # explanation.plot_graph(save_path="/home/ai/bwfan/TAGAttack_Word_Level/data/pic/pic.png")
        return explanation, sub_edge_index
